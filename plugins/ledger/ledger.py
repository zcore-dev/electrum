...
from electrum.zcore import TYPE_ADDRESS, int_to_hex, var_int
...
class Ledger_Client():
    ...
    def get_xpub(self, bip32_path, xtype):
        ...
        xpub = zcore.serialize_xpub(xtype, nodeData['chainCode'], publicKey, depth, self.i4b(fingerprint), self.i4b(childnum))
        return xpub
